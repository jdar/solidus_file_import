...
for variant_attrs in array_of_variant_attrs
  found = Spree::Variant.find_by_product_id(variant_attrs[:product].id)
  if found
    found.update_attributes(variant_attrs) 
  else
